...
![image](screenshots\Skills-Folder.png)
...
![image](screenshots\scaffold-terraform.png)

---

#### Screenshot 3 — Screenshot 3 — `tf-plan/SKILL.md` frontmatter showing `allowed-tools: Bash, Read, Grep` (no Write) and `disable-model-invocation: true`

![image](screenshots\Terraform-Plan.png)
...
![image](screenshots\scaffold-file-list.png)

---

#### Screenshot 5 — VS Code sidebar showing the `terraform/` folder with all generated files inside

![image](screenshots\Terraform-folder.png)
...
![image](screenshots\tf-plan 1.png)
![image](screenshots\tf-plan.1.1.png)
![image](screenshots\tf-plan.1.2.png)
